...
class PwInputConverter(RawInputConverter):
    ...
    PW_TEMPLATE_MAP = {
        ...
        'free_positions': {
            '_text': ("ATOMIC_POSITIONS", cards.get_atomic_positions_cell_card, None)
        },
        'electric_field': {
            'electric_potential': [
...
class NebInputConverter(RawInputConverter):
    ...
    def __init__(self,**kwargs):
        ...
        ENGINE_TEMPLATE_MAP['free_positions'] = ("ATOMIC_POSITIONS", cards.get_neb_images_positions_card, None)
